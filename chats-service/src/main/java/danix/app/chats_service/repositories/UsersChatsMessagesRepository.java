...
@Repository
public interface UsersChatsMessagesRepository extends JpaRepository<ChatMessage, Long> {

	List<ChatMessage> findAllByChatAndContentTypeIsNot(UsersChat chat, ContentType contentType, Pageable pageable);
